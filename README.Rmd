...
system(command = "cp vignettes/overview.html docs/index.html")
```
...
[![CRAN_Downloads_Badge](http://cranlogs.r-pkg.org/badges/tadaatoolbox)](http://cran.r-project.org/package=tadaatoolbox)
...
version in this repository [on GitHub pages](http://tadaadata.github.io/tadaatoolbox/).
