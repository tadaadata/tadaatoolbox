...
[![R build status](https://github.com/tadaadata/tadaatoolbox/workflows/R-CMD-check/badge.svg)](https://github.com/tadaadata/tadaatoolbox/actions)
...
* `tadaa_aov`: For 3 flavours of `aov` with included partial $\eta^2$ and Cohen's f.
